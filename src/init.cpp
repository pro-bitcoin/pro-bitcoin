...
bool AppInitMain(NodeContext& node, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    //configMetrics.SetFlag("rpcport", static_cast<size_t>(OptionsCategory::RPC, args.GetArg("-rpcport", DEFAULT_RPC));
    ...
    configMetrics.Set("bantime", static_cast<size_t>(OptionsCategory::CONNECTION), "seconds", args.GetArg("-bantime", DEFAULT_MISBEHAVING_BANTIME));
    configMetrics.Set("blockmaxweight", static_cast<size_t>(OptionsCategory::BLOCK_CREATION), "int", args.GetArg("-blockmaxweight", DEFAULT_BLOCK_MAX_WEIGHT));
    configMetrics.Set("blockmintxfee", static_cast<size_t>(OptionsCategory::BLOCK_CREATION), "int", args.GetArg("-blockmintxfee", DEFAULT_BLOCK_MIN_TX_FEE));
    configMetrics.Set("bytespersigop", static_cast<size_t>(OptionsCategory::NODE_RELAY), "bytes", nBytesPerSigOp);
    configMetrics.Set("checkblocks", static_cast<size_t>(OptionsCategory::DEBUG_TEST), "int", args.GetArg("-checkblocks", DEFAULT_CHECKBLOCKS));
    configMetrics.Set("checklevel", static_cast<size_t>(OptionsCategory::DEBUG_TEST), "int", args.GetArg("-checklevel", DEFAULT_CHECKLEVEL));
    ...
    configMetrics.Set("dbcache", static_cast<size_t>(OptionsCategory::OPTIONS), "bytes", nTotalCache);
    ...
    configMetrics.Set("maxorphantx", static_cast<size_t>(OptionsCategory::OPTIONS), "int", args.GetArg("-maxorphantx", DEFAULT_MAX_ORPHAN_TRANSACTIONS));
    configMetrics.Set("maxsigcachesize", static_cast<size_t>(OptionsCategory::DEBUG_TEST), "bytes", args.GetArg("-maxsigcachesizze", DEFAULT_MAX_SIG_CACHE_SIZE) * 1024 * 1024);
